...
Page({
    data: {
        ...
        menu: [],
        menu_a: [
            { id: 1, picUrl: "../../images/jxhd_01.jpg" },
            { id: 2, picUrl: "../../images/jxhd_02.jpg" },
        ],
        goodsList: [],
        fenlei: [],
        isLoading: 0,
    ...
    onLoad: function() {
        ...
        this._getAllIndexMessage();
        this._getAllIndexMessage2();
    ...
    activeTap: function(e) {
        var aid = e.currentTarget.dataset.active;
        console.log(aid)
        if (aid === 1) {
            wx.navigateTo({
